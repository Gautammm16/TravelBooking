...
//   //       if (key === 'preferences') {
//   //         for (const prefKey in formData.preferences) {
//   //           form.append(`preferences.${prefKey}`, formData.preferences[prefKey]);
//   //         }
...
//         // Ensure favorites is properly formatted
//         if (Array.isArray(formData.favorites)) {
//           // Clean the favorites array - remove any empty or invalid values
//           const cleanFavorites = formData.favorites.filter(fav => fav && fav.trim() !== '');
//           form.append('favorites', JSON.stringify(cleanFavorites));
//         }
//       } else if (key === 'avatar' && formData.avatar instanceof File) {
//         form.append('avatar', formData.avatar);
//       } else if (key !== 'createdAt') { // Exclude createdAt
//         form.append(key, formData[key]);
//       }
//     }
...
//                         (err.status === 400 ? 'Invalid data format' : 'Failed to update profile');
