        ...
        <div className="relative hidden md:block ml-4">
          ...
          {isDropdownOpen && (
            <ul className="absolute right-0 mt-2 bg-white text-black shadow-lg rounded-md w-40 z-10">
              {user ? (
                <>
                  <li><Link to="/profile" className="block px-4 py-2 hover:bg-gray-100" onClick={handleLinkClick}>Profile</Link></li>
                  <li><Link to="/my-bookings" className="block px-4 py-2 hover:bg-gray-100" onClick={handleLinkClick}>My Bookings</Link></li>
                  <li>
                    <Link
                      to="/my-custom-tours"
