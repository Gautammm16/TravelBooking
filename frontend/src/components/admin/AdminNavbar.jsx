...
const AdminNavbar = () => {
  const navLinkClass = ({ isActive }) =>
    isActive
      ? 'text-white bg-blue-600 px-4 py-2 rounded w-full'
      : 'text-blue-600 hover:text-white hover:bg-blue-600 px-4 py-2 rounded w-full transition';

  return (
    <nav className="bg-gray-100 p-4 shadow min-h-screen w-64">
