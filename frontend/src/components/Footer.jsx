...
<footer class="bg-white dark:bg-gray-900     w-screen">
      ...
      <div class="grid grid-cols-2 gap-8  py-8 md:grid-cols-4 ">
        <div>
            ...
            <ul class="text-gray-500 dark:text-gray-400">
                ...
                <li class="mb-4">
                    <a href="/destination" class="hover:underline">Destination</a>
                </li>
                <li class="mb-4">
    ...
    <div class="px-4 py-6   bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
        <span class="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2025 <a href="#">Price</a>. All Rights Reserved.
        </span>
